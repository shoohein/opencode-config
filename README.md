...
[![Format Check](https://github.com/shoohein/opencode-config/actions/workflows/format-check.yml/badge.svg)](https://github.com/shoohein/opencode-config/actions/workflows/format-check.yml)
...
- `agents/` — カスタムエージェント定義(English)
- `commands/` — カスタムコマンド定義(Japanese)
- `skills/` — 再利用可能なスキル定義(English)
- `instructions/` — 追加指示ファイル(English)
